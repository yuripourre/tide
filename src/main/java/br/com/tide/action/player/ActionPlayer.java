...
public class ActionPlayer<T> extends ActivePlayer<T> implements ControllerListener {
	...
	private ActionPlayerListener<T> listener;
	...
	public ActionPlayer(int x, int y, ActionPlayerListener<T> listener) {
		this(x, y);
	...
	public void setListener(ActionPlayerListener<T> listener) {
		this.listener = listener;
