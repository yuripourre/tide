...
public class PlatformPlayer<T> extends ActivePlayer<T> implements ControllerListener {
	...
	protected PlatformPlayerListener<T> listener;
	
	public PlatformPlayer() {
		super();
	}
	
	public PlatformPlayer(PlatformPlayerListener<T> listener) {
		super();
